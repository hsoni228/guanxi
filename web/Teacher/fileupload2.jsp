  ...
  //    factory.setRepository(new File("/root/C/"+user));
      ...
      try{ 
         ...
         while ( i.hasNext () ) 
         {
          ...
          String sql="insert into file"+table+" values('teacher','"+filePath+fileName+"')";  
          //out.println("    ksldkasdlaskdl   "+sql);
          Statement s=c.createStatement();
          s.executeUpdate(sql);
          String site ="http://localhost:8080/Guanxi/Teacher/fileupload.jsp";
            response.setStatus(response.SC_MOVED_TEMPORARILY);
            response.setHeader("Location", site); 
            }
         }

    ...
    <body>
       ...
       { 
        ...
        response.setHeader("Location", site); 
           ...
           String sql1="select subject from subject1 where section='"+sec+"' and year='"+year+"'";
           Statement s1 = c.createStatement();
           ResultSet rs1=s1.executeQuery(sql1);
           out.println("<form action='fileuploadstudent1.jsp' method='post'><center><table class='tsc_table_s9' summary='Sample Table' style='width:80%;'><thead><tr><th>S No.</th><th>Year</th><th>Subject</th><th>Section</th></tr></thead><tfoot><tr><th scope='row'>Total</th><td colspan='7'>4 buildings</td></tr></tfoot><tbody>");
           int count=1;
           while(rs1.next())
           {
